...
class SetKeyCommand extends BaseCommand{
    ...
    public function __construct(Main $main){
        parent::__construct("setkey", $main);
        $this->main = $main;
        $this->setDescription("Set key to a player.");
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) : bool{
        ...
        if($args[1] == in_array($args[1], ["Common", "Vote", "Rare", "Legendary"])){
            ...
            $this->cfg->save();
            $sender->sendMessage(TextFormat::GREEN . "Successfully Set {$player->getName()} $args[2] $args[1] Crate Key!");
        }else{
